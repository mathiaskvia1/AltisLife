...
private[""_msg"",""_to""];
	...
	hint format[""You have sent a message to all Nation Health Service Units."",_to,_msg];
	ctrlShow[3022,true];
";
//To One Person
...
compileFinal "
	...
	[] call life_fnc_cellphone;
	hint format[""Staff Message Sent To: %1 - Message: %2"",name _to,_msg];
	ctrlShow[3020,true];
";
...
compileFinal "
	...
	[] call life_fnc_cellphone;
	hint format[""Staff Message Sent To All: %1"",_msg];
	ctrlShow[3021,true];
";
...
publicVariable "TON_fnc_cell_NHSrequest";
//Client Message
/*
	0 = private message
	1 = police message
...
compileFinal "
	...
	switch (_type) do
	{
		...
		case 2 :
		{
			...
			_loc = _this select 3;
			_unit = _this select 4;
			_message = format[""Staff Request FROM %1: %2"",_from,_msg];
			if(isNil ""_loc"") then {_loc = ""Unknown"";};
			hint parseText format [""<t color='#ffcefe'><t size='2'><t align='center'>Staff Request<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>Admins<br/><t color='#33CC33'>From: <t color='#ffffff'>%1<br/><t color='#33CC33'>Coords: <t color='#ffffff'>%2<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%3"",_from,_loc,_msg];

			[""AdminDispatch"",[format[""%1 Has Requested one from Staff!"",_from]]] call bis_fnc_showNotification;
			systemChat _message;
		};
		...
		{
			private[""_message""];
			_message = format[""!!! Staff Message: %1"",_msg];
			_admin = format[""Sent by admin: %1"", _from];
			hint parseText format [""<t color='#640c91'><t size='2'><t align='center'>Staff Message<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>You<br/><t color='#33CC33'>From: <t color='#ffffff'>An Admin<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%1"",_msg];
		...
		case 4 :
		{
			...
			_message = format[""SERVER MESSAGE: %1"",_msg];
			_admin = format[""Message sent by Game Admins"", _from];
			hint parseText format [""<t color='#640c91'><t size='2' font='PuristaBold'  ><t align='center'>Server Message<br/><br/><t color='#2c8937'><t align='left'><t size='1'>To: <t color='#ffffff'>All Players<br/><t color='#2c8937'>From: <t color='#ffffff'>The Staff Team<br/><br/><t color='#2c8937'>Message:<br/><t color='#ffffff'>%1"",_msg];

			[""AdminMessage"",[""You Have Received A Message From Staff Team""]] call bis_fnc_showNotification;
			systemChat _message;
			if((call life_adminlevel) > 0) then {systemChat _admin;};
		};
		...
		case 5: {
			...
			_loc = _this select 3;
			_unit = _this select 4;
			_message = format[""!!! NHS REQUEST: %1"",_msg];
			hint parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>NHS Request<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>You<br/><t color='#33CC33'>From: <t color='#ffffff'>%1<br/><t color='#33CC33'>Coords: <t color='#ffffff'>%2<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%3"",_from,_loc,_msg];

			[""TextMessage"",[format[""NHS Request from %1"",_from]]] call bis_fnc_showNotification;
		};
	};
";
